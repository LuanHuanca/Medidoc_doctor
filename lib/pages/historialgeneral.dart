...
class HistorialGeneral extends StatefulWidget {
  const HistorialGeneral({super.key});

  @override
  State<HistorialGeneral> createState() => _HistorialGeneralState();
}
...
class _HistorialGeneralState extends State<HistorialGeneral> {
  ...
  void _navigateToDetail(BuildContext context, Map<String, dynamic> user) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => CarpetasPaciente(user: user),
      ),
    );
  }
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) => Card(
                  ...
                  child: ListTile(
                    ...
                    onTap: () => _navigateToDetail(context, _foundUsers[index]),
                  ),
                ),
              ),
            ),
